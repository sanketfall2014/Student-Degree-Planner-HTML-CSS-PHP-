    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in" style="color:orange;">Your Profile will look like this when you select <?php if(strcmp($track,gettrack($tr))){echo $track;}
				else{echo $track1;}?> track</div>
				<form action="user.php" method="POST">
				  <div class="intro-lead-in" style="color:orange;">Confirm change of track</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">The track you choose is <?php if(strcmp($track,gettrack($tr))){echo $track;}
				else{echo $track1;}?></h3>
                </div>
            </div>
            <div class="row text-center">
                ...
                <div class="col-md-4">
					...
					<p class="text-muted">Track: <?php if(strcmp($track,gettrack($tr))){echo $track;}
				else{echo $track1;}?></p>
