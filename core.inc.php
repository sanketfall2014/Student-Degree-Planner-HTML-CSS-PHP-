...
$field = "LastLogin";
  ...
  $query1 = "SELECT `$field` FROM `users` WHERE `uid` ='". $_SESSION['user_id']."'";
...
function getuserfield($field) {
  ...
  $query = "SELECT `$field` FROM `users` WHERE `uid` ='". $_SESSION['user_id']."'";
...
function gettrack($field) {

  $query = "SELECT `$field` FROM `usertrack` WHERE `username` ='". $_SESSION['user_id']."'";
...
function getadvfield($field) {

  $query = "SELECT `$field` FROM `advisor` WHERE `id` ='". $_SESSION['user_id']."'";
...
function gettimefield($field) {
  ...
  $query = "SELECT `$field` FROM `regtslot` WHERE `username` ='". $_SESSION['user_id']."'";
